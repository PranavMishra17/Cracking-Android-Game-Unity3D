...
public class RopeControllerRealisticNoSpring : MonoBehaviour
{
    ...
    public Transform whatTheRopewillbeConnectedTo;
    public Transform whatIsHangingFromTheRope;

    public bool rope_detached = false;
    ...
    //Rope data
    private float ropeSectionLength = 0.4f;
    ...
    private void Update()
    {
        if (rope_detached)
        {
            ...
            whatTheRopeIsConnectedTo = whatTheRopewillbeConnectedTo;
        }
